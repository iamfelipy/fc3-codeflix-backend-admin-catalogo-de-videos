...
describe("Category Without Validator Unit Tests", () => {
  ...
  describe("create command", () => {
    test("should create a category", () => {
      ...
      expect(category.created_at).toBeInstanceOf(Date);
      /*
        Pergunta: Por que chamar category.validate não funciona com toHaveBeenCalledTimes?

Resposta: Porque o mock está em Category.prototype.validate; ao acessar direto por category.validate, não necessariamente é o mock que o Jest rastreia.
      */
