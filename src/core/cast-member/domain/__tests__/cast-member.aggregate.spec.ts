...
describe('CastMember Unit Tests', () => {
  beforeEach(() => {
    // isso é feito para "espiar" (spy) a função validate do CastMember no Jest, permitindo monitorar chamadas sem alterar sua implementação real. Assim, todos os testes que envolverem validate podem verificar se ela foi chamada corretamente, mas mantendo seu comportamento original.
