...
describe('CastMemberModel Integration Tests', () => {
  ...
  test('create', async () => {
    ...
    // A função create do Sequelize cria e salva uma nova instância no banco de dados usando os dados do objeto passado (arrange). Ela retorna a instância criada, já persistida.
