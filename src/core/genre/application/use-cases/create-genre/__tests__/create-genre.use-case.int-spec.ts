...
describe('CreateGenreUseCase Integration Tests', () => {
  ...
  it('rollback transaction', async () => {
    ...
    // No mock Genre.create, o objeto genre criado manualmente tem name com 256 caracteres (inválido). Ao executar useCase.execute, quando tenta salvar no banco, o Sequelize tenta persistir esse nome inválido e dispara um DatabaseError porque viola a restrição de tamanho da coluna no banco de dados.
