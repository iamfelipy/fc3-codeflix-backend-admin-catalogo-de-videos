...
function formatOutput(genre, categories) {
  ...
  return {
    ...output,
    // expect.objectContaining e expect.arrayContaining permitem comparar objetos/arrays parcialmente e sem se importar com a ordem, enquanto se comparar "cru" (categories: output.categories), o teste vai exigir igualdade estrita (mesma ordem, mesmas instâncias/propriedades). Se o array de categorias vier em ordem diferente, ou se algum objeto tiver propriedades extras, o teste vai falhar.
