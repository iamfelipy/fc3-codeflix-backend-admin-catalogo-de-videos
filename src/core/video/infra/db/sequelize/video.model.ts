...
export class VideoModel extends Model<VideoModelProps> {
  ...
  // No Sequelize (e bancos como MySQL/Postgres), DATE armazena em formato YYYY-MM-DD HH:MM:SS[.ffffff], onde [.ffffff] são os microssegundos opcionais (até 6 dígitos se usar precisão).
