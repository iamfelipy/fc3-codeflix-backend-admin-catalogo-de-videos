import { IDomainEvent, IIntegrationEvent } from '../../../shared/domain/events/domain-event.interface';
...
{
  // declare serve para informar ao TypeScript que essas propriedades existem, mas não estão sendo inicializadas no construtor; isso evita erros de compilação sem gerar código JS real.
