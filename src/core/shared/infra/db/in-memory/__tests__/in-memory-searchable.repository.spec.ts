...
// Entity tem o metodo abstract get entity_id, pq nao deu erro?
// O erro não ocorre porque, embora a classe abstrata Entity defina get entity_id() como abstrato, o TypeScript permite que subclasses implementem esse requisito tanto como um getter quanto como uma propriedade pública chamada entity_id. O TypeScript aceita ambos como implementação válida de um getter abstrato. Assim, declarar entity_id: Uuid; na subclasse cumpre o contrato da base.
...
describe('InMemorySearchableRepository Unit Tests', () => {
  ...
  describe('applySort method', () => {
    it('should no sort items', async () => {
      ...
      // price não faz parte dos campos de ordenação, por isso testamos se não ordena.
      ...
      const arrange = [
        {
          ...
          result: new SearchResult({
            // pq name test, não está vindo como primeiro?
            // Porque o sort diferencia maiúsculas de minúsculas em strings: 'TEST' (todas maiúsculas) vem antes de 'test' (todas minúsculas) na ordenação alfabética padrão do JavaScript.
            // Exato, o filter usa toLowerCase() para comparar, mas o sort compara os nomes diretamente, sem normalizar para minúsculas.
