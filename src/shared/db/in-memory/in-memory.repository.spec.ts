...
/*
Um "stub" é uma implementação simplificada ou falsa de uma classe, função ou objeto usada em testes. Ele substitui componentes reais para isolar a unidade sob teste, permitindo controlar cenários e dados. No exemplo, StubEntity e StubInMemoryRepository são versões dummy usadas só para testar o repositório.

Não. Stub fornece dados simulados, mas não verifica chamadas. Mock, além de simular, verifica se métodos foram chamados, argumentos etc. Ou seja, mocks testam comportamento e interação; stubs apenas fornecem respostas pré-definidas.
*/
