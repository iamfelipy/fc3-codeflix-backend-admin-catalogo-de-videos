...
export class ValidatorRules {
  ...
  // omit não deixar chamar required novamente
  // Isso previne que o método required() seja chamado mais de uma vez em cadeia, evitando validações repetidas e tornando o uso da API mais seguro.
