...
export class CategoriesController {
  ...
  // O NestJS identifica o DTO pelo tipo usado na assinatura do parâmetro (updateCategoryDto: UpdateCategoryDto), não pelo nome da variável. O nome não importa, só o tipo.
