...
describe('GenresController Integration Tests', () => {
  ...
  describe('search method', () => {
    describe('should returns genre using query empty ordered by created_at', () => {
      const { relations, entitiesMap, arrange } =
        ListGenresFixture.arrangeIncrementedWithCreatedAt();

      beforeEach(async () => {
        /*
          Com DB_HOST=":memory:", cada conexão SQLite ganha um banco privado na memória. Conexão nova = banco vazio, sem ver o que outra conexão inseriu.
        */
