...
/*
- **Fixture:** conjunto de dados, objetos e configurações preparados para um teste.
- **Arrange:** etapa de preparar tudo o que o teste precisa antes da ação.

Integração: ligação e funcionamento conjunto de duas ou mais partes.
Exemplo: O sistema de login envia dados para o banco de dados e ambos funcionam juntos.

Teste: processo de verificar se algo funciona como esperado.
Exemplo: Fazer login com uma senha correta para verificar se o acesso é permitido.
*/
